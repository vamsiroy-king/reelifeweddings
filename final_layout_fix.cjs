...
// 1. Fix main.js to use slidesPerView: 'auto'
let js = fs.readFileSync('C:/reelifeweddingsAG/js/main.js', 'utf8');

js = js.replace(/slidesPerView: 1\.5,[\s\S]*?breakpoints: {[\s\S]*?768: { slidesPerView: 3 },[\s\S]*?1024: { slidesPerView: 5 }[\s\S]*?},/, "slidesPerView: 'auto',");

fs.writeFileSync('C:/reelifeweddingsAG/js/main.js', js, 'utf8');


// 2. Fix index.html to strictly have the 6 slides and remove any extra ones
...
console.log('Fixed swiper auto layout and cleaned slides!');
